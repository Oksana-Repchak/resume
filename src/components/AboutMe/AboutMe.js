    ...
    <div className={s.container}>
      <div className={s.section}>
        ...
        <p className={s.description}>
          I’m looking for a job for the position of front-end developer. I want to be in a good team, where I could improve my skills
          and use them for interesting tasks. I am a fast learner and very responsible.
        </p>
      </div>
      <div className={s.section}>
